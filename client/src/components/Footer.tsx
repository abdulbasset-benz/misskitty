      ...
      <div className="container mx-auto px-6 py-16 relative z-10">
          ...
          <div className="lg:col-span-5">
            <div className="space-y-6">
              ...
              <p className="text-gray-300 leading-relaxed text-lg max-w-md font-light">
                Discover elegance with Miss Kitty - your premier destination for exquisite dresses. 
                From stunning evening gowns to chic cocktail dresses, we curate timeless pieces 
                that celebrate your unique style and grace.
              </p>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="max-w-md">
            <h4 className="text-lg font-serif font-light mb-4">Stay Updated</h4>
            <div className="flex flex-col sm:flex-row gap-3">
              <input 
                type="email" 
                placeholder="Enter your email"
                className="flex-1 px-4 py-3 bg-gray-800 border border-gray-700 rounded-lg text-white placeholder-gray-400 focus:outline-none focus:border-[#f7ce83] transition-colors duration-300"
              />
              <button className="px-6 py-3 bg-gradient-to-r from-[#f7ce83] to-[#d4b985] text-gray-900 rounded-lg font-medium hover:from-[#e0b972] hover:to-[#c0a46c] transition-all duration-300 transform hover:-translate-y-0.5">
                Subscribe
              </button>
            </div>
        ...
        <div className="container mx-auto px-6 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-3 md:space-y-0">
            ...
            <div className="flex items-center space-x-6 text-sm text-gray-400 font-light">
              <a href="/privacy" className="hover:text-[#f7ce83] transition-colors duration-300">Privacy Policy</a>
              <a href="/terms" className="hover:text-[#f7ce83] transition-colors duration-300">Terms of Service</a>
              <a href="/shipping" className="hover:text-[#f7ce83] transition-colors duration-300">Shipping Info</a>
            </div>
          </div>
        </div>
      </div>
